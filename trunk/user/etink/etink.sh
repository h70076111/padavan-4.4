...
start_core() {
	...
	etcmd="cd $bin_path ; ./easytier-core --network-name $etink_keyg --network-secret $etink_pass -i $etink_xyip -p $etink_log $etink_log2 $etink_log3 --machine-id $core_uuid >/tmp/easytier.log 2>&1"
